...
export function Calendar({ selectedDate, setSelectedDate, daysWithAppointments }: ICalendarProps) {
  ...
  const handleCurrentDayPress = useCallback(() => {
    ...
    setSelectedDate(TODAY_FORMATTED);
  }, [TODAY_FORMATTED, setSelectedDate]);
