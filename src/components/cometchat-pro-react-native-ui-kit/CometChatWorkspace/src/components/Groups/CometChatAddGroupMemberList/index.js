      ...
      .then(() => {
        this.AddMembersManager.fetchNextUsers()
          ...
          .catch((error) => {
            ...
            logger('[CometChatAddGroupMemberList] getUsers fetchNext error', error);
          });
      })
      .catch((error) => {
        this.decoratorMessage = 'Error';
        logger('[CometChatAddGroupMemberList] getUsers getLoggedInUser error', error);
      });
  };
                    ...
                    <View style={style.reactionDetailsContainer}>
                      ...
                      >
                        ...
                        <TouchableWithoutFeedback onPress={() => this.textInputRef.current.focus()}>
                          ...
                          >
                            <Icon name="search" size={15} color={this.theme.color.helpText} />
                            <TextInput
