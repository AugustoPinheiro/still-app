...
class CometChatImageViewer extends React.Component {
  ...
  render() {
    return (
      ...
      >
        <TouchableOpacity onPress={() => this.props.close()} style={style.outerContainer}>
          <BottomSheet
            ref={this.sheetRef}
              ...
              return (
                <TouchableWithoutFeedback>
                  <View style={style.bottomSheetContainer}>
                    <TouchableOpacity style={style.crossImgContainer} onPress={this.props.close}>
                      <Image source={cross} style={style.crossImg} contentFit="contain" />
                    </TouchableOpacity>
