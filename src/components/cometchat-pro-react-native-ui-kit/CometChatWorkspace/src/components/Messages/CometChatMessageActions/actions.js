...
export default (props) => {
  ...
  if (
    ...
    sendMessage = (
      <TouchableOpacity
        ...
        <Text style={styles.actionsText}>Enviar mensagem em particular</Text>
      </TouchableOpacity>
    );
  }
  let threadedChats = (
    <TouchableOpacity
      ...
      <FeatherIcon name="message-circle" size={actionIconSize} />
      <Text style={styles.actionsText}>Criar Thread</Text>
    </TouchableOpacity>
  );
  ...
  let deleteMessage = (
    <TouchableOpacity
      ...
      <Text style={styles.actionsText}>Deletar mensagem</Text>
    </TouchableOpacity>
  );
  ...
  let editMessage = (
    <TouchableOpacity
      ...
      <Text style={styles.actionsText}>Editar mensagem</Text>
    </TouchableOpacity>
  );
