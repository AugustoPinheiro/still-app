export class UIKitSettings {
  ...
  constructor() {
    ...
    this.groupInMode = UIKitSettings.groupListFilterOptions.PUBLIC_AND_PASSWORD; // left
    ...
    this.enableSoundForMessages = false;
    ...
    this.sendGifs = true;
    this.shareCopyForwardMessage = true;
    this.sendFiles = true;
