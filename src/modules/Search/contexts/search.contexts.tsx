...
export const SearchProvider = ({ children }: SearchProviderProps) => {
  ...
  const fetchSearchPersonalStylist = async ({ pageParam }) => {
    try {
      console.log('Buscando personal stylist com filtro:', filterStylist);
      const data = await searchProfiles('professional', searchPersonalStylist, pageParam, filterStylist);
      console.log('Resultado da busca:', data?.data?.length, 'itens');
  ...
  const {
    ...
    refetch: refetchPersonalStylist,
  } = useInfiniteQuery({
