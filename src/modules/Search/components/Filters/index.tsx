...
interface FiltersProps {
  ...
  setFilters: (filters: { categories?: number[]; attributes?: number[] } | undefined) => void;
}

export function Filters({ closeBottomSheet, setFilters }: FiltersProps) {
  ...
  const onSubmit = async (data: SchemaFieldsType) => {
    setFilters({ categories: selectedCategories, attributes: data?.attributes });
