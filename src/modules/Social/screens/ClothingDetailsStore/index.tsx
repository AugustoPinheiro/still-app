...
export function ClothingDetailsStore() {
  ...
  return (
    <>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <S.SectionButton onPress={() => setInspiration(item?.inspiration)}>
                  <S.SectionImage source={{ uri: item?.inspiration?.image }} cachePolicy="disk" />
                </S.SectionButton>
              )}
            />
          </S.Section>
        ...
        {clothing?.link ? (
          <S.ButtonContainer>
            <Button
              ...
              disabled={!clothing?.link}
              onPress={async () => {
                await Linking.openURL(clothing?.link);
              }}
            />
          </S.ButtonContainer>
        ) : (
      ...
      {inspiration ? (
        <Modal full closeOnClick onClickOutside={() => setInspiration(null)}>
