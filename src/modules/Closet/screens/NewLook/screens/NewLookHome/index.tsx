...
import { BottomSheetContent } from '@/modules/Closet/screens/NewLook/components/BottomSheetContent';
import { SidebarFloat } from '@/modules/Closet/screens/NewLook/components/SidebarFloat';
...
export function NewLookHome({ navigation }: { navigation: NavigationProp<any> }) {
  const bottomSheetRef = useRef<BottomSheet>(null);
  const viewContainerRef = useRef<View>(null);
  const { params } = useRoute<RouteProp<NewLookParams, 'origin'>>();
